...
const EmailVerificationPage = () => {
  ...
  return (
    <div className="w-full max-w-md overflow-hidden bg-gray-800 bg-opacity-50 shadow-xl  file:backdrop-filter backdrop-blur-xl rounded-2xl">
      <motion.div
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="w-full max-w-md p-8 overflow-hidden bg-gray-800 bg-opacity-50 shadow-2xl backdrop-filter backdrop-blur-xl rounded-2xl">
